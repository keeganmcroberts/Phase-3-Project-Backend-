...
Expense.create(date:"1/17/22", expense_name:"This Months Power Bill", amount: 84.02, user_id: mallory.id, category_id: power_bill.id)
Expense.create(date:"2/24/22", expense_name:"This Months Internet Bill", amount: 63.77, user_id: john.id, category_id: internet_bill.id)
Expense.create(date:"2/26/22", expense_name:"This Months Phone Bill", amount: 120.65, user_id: sarah.id, category_id: phone_bill.id)
